	...
	class BTBB_Light {
		...
		function admin_edit_page() {
			...
			<form method="post" action="<?php echo esc_url( add_query_arg( array( 'post' => $post_id ), menu_page_url( $this->slug, false ) ) ); ?>">
				...
				<li class="bt-bb-light-home-page"><a href="<?php echo esc_url( $this->home_url ); ?>" target="_blank"><?php esc_html_e( 'Home page', 'boldthemes_framework_textdomain' ); ?></a></li>
				<?php
				if ( current_user_can( 'activate_plugins' ) && $this->product_id != '' ) { ?>
					<li class="bt-bb-light-licence"><a href="<?php echo esc_url( admin_url( 'admin.php?page=' . $this->license_slug ) ); ?>" target="_blank"><?php esc_html_e( 'Product License', 'boldthemes_framework_textdomain' ); ?></a></li>
				<?php }
				if ( $this->doc_url != '' ) { ?>
					<li class="bt-bb-light-documentation"><a href="<?php echo esc_url( $this->doc_url ); ?>" target="_blank"><?php esc_html_e( 'Documentation', 'boldthemes_framework_textdomain' ); ?></a></li>
				<?php }
				if ( $this->support_url != '' ) { ?>
					<li class="bt-bb-light-support"><a href="<?php echo esc_url( $this->support_url ); ?>" target="_blank"><?php esc_html_e( 'Support', 'boldthemes_framework_textdomain' ); ?></a></li>
				<?php } ?>
		...
		function admin_license_page() {
			...
			<form method="post" action="">
				...
				<p class="bt-bb-light-description"><?php esc_html_e( 'If you do not have a license or you have activated a license on another site, then you can ', 'boldthemes_framework_textdomain' ); ?><a href="<?php echo esc_url( $this->home_url ); ?>" target="_blank"><em><?php esc_html_e( 'purchase a license here', 'boldthemes_framework_textdomain' ); ?></em></a><?php esc_html_e( '.', 'boldthemes_framework_textdomain' ); ?></p>
